...
export const PlayerSettings = () => {
	...
	const playervalidations = yup.object().shape({
		level: yup.string().required(),
		medal: yup.string().required(),
	...
	const playerInforChangeHandler = (key , value ) => {
		setPlayerData((p ) => ({
			...p,
			[key]: value
		}))
		...
		<MainSidebar>
			<Container>
						...
						<>
							<Form>
								...
								<Row>
									...
									<Col md={4}>
										<Container className="d-flex profile-img">
											<FileInput
												name="image"
												loading={fileLoading}
				...
				<Formik
					...
					validationSchema={playervalidations}
						...
						<>
							<Form>
								<Row>
									...
									<h5 className="fw-bold mt-4">Player Info</h5>
									...
									<Col md={4}>
										<Input
											...
											changeHandler={playerInforChangeHandler}
										/>
									</Col>
									<Col md={4}>
										<Input

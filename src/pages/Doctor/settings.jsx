...
export const DocctorSettings = () => {
	...
	const [doctorData, setDoctorData] = useState({
		...
		clinicPhoneNumber: user?.clinicPhoneNumber ?? "",
		clinicTiming: user?.clinicTiming ?? "",
	...
	const doctorvalidations = yup.object().shape({
		...
		clinicPhoneNumber: yup.string().required(),
		clinicAddress: yup.string().required(),
		clinicTiming: yup.string().required(),
	...
	const doctorInforChangeHandler = (key , value ) => {
		setDoctorData((p ) => ({
			...p,
			[key]: value
		}))
								...
								<Row>
									...
									<Col md={4}>
										<Input
											...
											changeHandler={doctorInforChangeHandler}
										/>
									</Col>
									<Col md={4}>
										<Input
									...
									<Col md={4}>
										<Input
											...
											value={doctorData.clinicPhoneNumber}
